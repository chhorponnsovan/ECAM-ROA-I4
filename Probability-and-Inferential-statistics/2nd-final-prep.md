...
- [Formula Sheet — Final Preparation](#formula-sheet--final-preparation)
  - [1. One-Way ANOVA](#1-one-way-anova)
    ...
    - [ANOVA Table Structure](#anova-table-structure)
  ...
  - [2. Simple Linear Regression](#2-simple-linear-regression)
    ...
    - [Sum of Squares](#sum-of-squares-1)
  - [3. Multiple Linear Regression](#3-multiple-linear-regression)
    - [Regression Equation](#regression-equation)
    - [Coefficient of Multiple Determination](#coefficient-of-multiple-determination)
  ...
  - [4. Global F-Test (Multiple Regression)](#4-global-f-test-multiple-regression)
    - [ANOVA Table (Multiple Regression)](#anova-table-multiple-regression)
  - [5. Individual Coefficient t-Test (Multiple Regression)](#5-individual-coefficient-t-test-multiple-regression)
  - [6. Correlation Matrix](#6-correlation-matrix)
  - [7. Residuals](#7-residuals)
  - [8. Means and Grand Mean (ANOVA)](#8-means-and-grand-mean-anova)
